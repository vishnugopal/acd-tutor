...
/**
 * Beep — the tutor mascot (amber body, cream belly, orange beak). Mood
 * animations (bob/cheer/tilt + blink) live in global.css as a small CSS rig
 * keyed off the `mascot`/mood classes, since they animate SVG internals.
 * Size/position come from the caller's className.
 */
